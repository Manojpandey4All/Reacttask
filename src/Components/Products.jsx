...
import { setProducts, setFailureStatus, setSuccessStatus } from "../redux/actions/productsActions"
...
export const Products = () => {
    ...
    const lastWeek = () =>{ 
        const updateList = products.payload.filter((items) => {
            return new Date(items.launch_date_utc).toLocaleDateString() === new Date().toLocaleDateString()
        })
                    ...
                    <div className='row  justify-content-center'>
                        ...
                        {loading ? (
                            ...
                            products.payload?.filter((value) => {
                                if (search === "") {
                                    return value
                                } else if (value.rocket.rocket_name.toLowerCase().includes(search.toLowerCase())) {
                                    return value
                                }
                            })
                                ?.map((items) => {
